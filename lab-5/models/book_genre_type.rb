...
module BookGenreType
  ...
  def self.all_types
    [
      MILITARY_AFFAIRS, BUSINESS_LITERATURE, DETECTIVES,
      CHILDREN_LITERATURE, NONFICTION_LITERATURE,
      HOME_AND_FAMILY, GENRE_NOT_DEFINED, CLASSIC,
      COMPUTERS_AND_INTERNET, ROMANCE_NOVEL,
      SCIENCE, SCIENTIFIC_AND_EDUCATIONAL,
      EDUCATION, POETRY_AND_DRAMA, ADVENTURES,
      PROSE, RELIGION_AND_SPIRITUALITY, REFERENCE_LITERATURE,
      ANCIENT_LITERATURE, TECHNIC, THRILLERS,
